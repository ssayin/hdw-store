...
int mainboard_select_only_ram_socket(mainboard_t* elem, processor_socket_t, ram_socket_t, unsigned int rsoc_count, unsigned int sd_count, unsigned int pw, unsigned int price);
